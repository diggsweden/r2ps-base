...
public class HSECPkdsSigner extends HSPKDSProvider implements JWSSigner {
  ...
  public HSECPkdsSigner(
      final HSPKDSAlgorithm hsPkdsAlgorithm, List<PKDSKeyDerivation> supportedKeyDerivations)
      throws JOSEException {
    this(hsPkdsAlgorithm, supportedKeyDerivations, null);
  }

  public HSECPkdsSigner(
      final HSPKDSAlgorithm hsPkdsAlgorithm, PKDSKeyDerivation supportedKeyDerivation)
      throws JOSEException {
  ...
  public ECPublicKey getRecipientKey(final PKDSHeaderParam pkdsHeaderParam) throws JOSEException {
    final PKDSPublicKey pkdsPublicKey =
        Optional.ofNullable(pkdsHeaderParam.getRecipientPublicKey())
            .orElseThrow(
                () -> new IllegalArgumentException("Recipient public key must be provided"));
