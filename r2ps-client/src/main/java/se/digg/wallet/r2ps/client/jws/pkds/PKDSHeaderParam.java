...
public class PKDSHeaderParam {
  ...
  private static class JWKSerializer extends JsonSerializer<JWK> {
    @Override
    public void serialize(final JWK jwk, final JsonGenerator jsonGenerator,
  ...
  private static class JWKDeserializer extends JsonDeserializer<JWK> {
    @Override
    public JWK deserialize(final JsonParser jsonParser,
  ...
  private static class Base64URLSerializer extends JsonSerializer<Base64URL> {
    @Override
    public void serialize(final Base64URL base64URL, final JsonGenerator jsonGenerator,
  ...
  private static class Base64URLDeserializer extends JsonDeserializer<Base64URL> {
    @Override
    public Base64URL deserialize(final JsonParser jsonParser,
        final DeserializationContext deserializationContext)
        throws IOException {
