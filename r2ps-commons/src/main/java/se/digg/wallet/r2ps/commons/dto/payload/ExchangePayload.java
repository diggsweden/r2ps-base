 ...
 *
 * <p>The payload includes a unique identifier (nonce) and a creation timestamp (iat). Subclasses
 * are expected to define specific data fields and validation logic relevant to their use cases.
 *
 * <p>This class also provides an abstract builder implementation for constructing and validating
