...
public record JWEEncryptionParams(
  ...
  public JWEEncryptionParams(
      final ECPublicKey staticPublicRecipientKey, final EncryptionMethod algorithm) {
    this(null, staticPublicRecipientKey, null, algorithm);
  }

  public JWEEncryptionParams(
      final ECPrivateKey staticPrivateRecipientKey, final EncryptionMethod algorithm) {
